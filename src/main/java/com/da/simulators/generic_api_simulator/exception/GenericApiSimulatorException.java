...
/**
 * Generic api simulation exception.
 */
public class GenericApiSimulatorException extends Exception
{
    @Serial
     ...
     */
    public GenericApiSimulatorException(final String message, final HttpStatus statusCode, final List<Message> messages)
    {
        super(message);
     ...
     */
    public GenericApiSimulatorException(final String message, final HttpStatus statusCode, final Message messageObject)
    {
        super(message);
        this.statusCode = statusCode;
     ...
     */
    public GenericApiSimulatorException(final String message, final HttpStatus statusCode, final List<Message> messages, final Throwable cause)
    {
        super(message, cause);
        this.statusCode = statusCode;
        this.messages.addAll(messages);
     ...
     * @param cause  The cause of this exception.
     */
    public GenericApiSimulatorException(final String message, final HttpStatus statusCode, final Message messageObject, final Throwable cause)
    {
        super(message, cause);
        this.statusCode = statusCode;
        this.messages.add(messageObject);
